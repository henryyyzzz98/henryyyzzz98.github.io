var app = (function () {
  ...
  //   EDIT THINGS HERE
    ...
    const HEARDLE_START_DATE = "2024-01-20";
    
    // make sure you have 7 comments here
    const HEARDLE_GAME_COMMENTS = [
        "You deserved a Grade F!", // FAILED
        "You deserved a Grade S!", // First try
        "You deserved a Grade A!",
        "You deserved a Grade B!",
        "You deserved a Grade C!",
        "You deserved a Grade D!",
  ...
  //   STOP EDITING NOW
    ...
    function Nt(t) {
      ...
      return {
        c() {
          (n = w("div")),
            (n.innerHTML =
              '<p class="mb-3">A clone of <a href="https://www.heardle.app/" title="Heardle">Heardle</a> for '+HEARDLE_ARTIST+' songs.</p><p class="mb-3">Each Kep1er Heardle is randomly chosen from Kep1er\'s discography on Soundcloud</p> \n\n<p class="mb-3">Created by Discord: henryz1112</a>. All copyright goes to the respective artists, companies, and other relevant parties.</p> \n\n\n\n <p class="mb-3"></p> \n\n\n\n <p class="mb-3"></p> \n\n\n\n <p class="text-xs mb-3 text-custom-line">Songs from <a href="https://soundcloud.com">Soundcloud</a>\n and powered on GitHub.'),
            M(n, "class", "text");
        },
        m(e, t) {
          g(e, n, t);
    ...
    function Dn(e, t, n) {
      ...
      return (
        (e.$$set = (e) => {
          "userStats_Kep1er" in e && n(11, (r = e.userStats_Kep1er)),
    ...
    function jn(e, t, n) {
      ...
      null == localStorage.getItem("userStats_Kep1er")
        ? ((h = []), localStorage.setItem("userStats_Kep1er", JSON.stringify(h)))
        : (h = JSON.parse(localStorage.getItem("userStats_Kep1er"))),
        (f = h.find((e) => e.id === l.id)),
        void 0 === f &&
          ((f = l),
          h.push(f),
          localStorage.setItem("userStats_Kep1er", JSON.stringify(h)));
      let g,
        y,
        v = f.guessList,
        w = {
