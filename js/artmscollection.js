...
function updateSelectedCollectionsMessage() {
    ...
    if (selectedARTMSCollections.length === 0)
        ...
        msgBar.textContent = "Selected collections: " + selectedARTMSCollections.join(", ");
}
...
document.getElementById("saveCollectionBtn").addEventListener("click", () => { 
    localStorage.setItem("selectedARTMSCollections", JSON.stringify(selectedARTMSCollections));
    generateRandomSet();
    displayCards();
    updateTabHighlights();
    updateSelectedCollectionsMessage();
